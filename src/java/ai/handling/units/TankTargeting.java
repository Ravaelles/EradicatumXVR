...
public class TankTargeting {
	...
	// for (Unit unit :
	// xvr.getUnitsOfType(UnitTypes.Terran_Siege_Tank_Siege_Mode)) {
	...
	// if (nearestEnemyDist >= 0 && (nearestEnemyDist < 2 || nearestEnemyDist <=
	// 7)) {
	...
	// // Cannon.
	// Unit topPriorityBuilding =
	// TargetHandling.findTopPriorityTargetIfPossible(
	...
	// }
	//
	// private static Unit defineOptimalStandardTarget(Unit unit,
	// ArrayList<Unit> enemiesInRange) {
	...
	// }
	//
	// private static Map<Unit, Double> defineBestTargets(Unit unit,
	// ArrayList<Unit> enemiesInRange) {
	...
	// continue;
	// }
	// enemiesToScore.put(enemy, evaluateOptionShootAtUnit(enemy,
	// enemiesInRange));
	// }
	//
	...
	//
	// private static Double evaluateOptionShootAtUnit(Unit enemy,
	...
	// // in this place
	// ArrayList<Unit> ourUnitsInRange = xvr.getUnitsInRadius(enemy,
	// OUTER_SPLASH_TILES, xvr
	// .getBwapi().getMyUnits());
	//
	// // ==============
	// // Define damage value
	...
	// // ==============
	// // OUTER DAMAGE
	// optionValue += calculatePointsFromDamageToEnemy(outerDamageValue,
	// enemiesInRange);
	...
	// // option
	// if (damageValue >= totalLife &&
	// !_unitsThatAreKilledIfThisOptionIsChosen.contains(unit)) {
	...
	// }
	//
	// private static double calculatePointsPenaltyFromDamageToUs(int
	// damageValue,
