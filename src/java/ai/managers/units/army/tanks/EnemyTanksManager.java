...
public class EnemyTanksManager {
	...
	private static final int MAXIMUM_TANKS_TO_ENGAGE_WITH_NORMAL_UNITS = 2;
	...
	// private static HashMap<Unit, MapPoint> enemyTankPositions = new
	// HashMap<>();
	...
	public static Collection<Unit> getEnemyTanks() {
