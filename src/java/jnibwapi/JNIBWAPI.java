 ...
 * functionality in BWAPI. Utility functions such as can buildHere have not yet
 * been implemented.<br>
 * 
...
public class JNIBWAPI {
	...
	static {
		try {
			...
			String driverName = "EradicatumXVR-driver-" + System.getProperty("os.arch");
	 ...
	 * C++ callback function.
	 * 
	 * Notifies the event listener that a connection has been formed to the
	 * bridge.
	 */
	 ...
	 * 
	 * Note: this is always called after matchEnded(bool), and is meant as a way
	 ...
	 * 
	 * @param type
	 *            - event type (should probably be an enum)
	 */
	...
	public boolean rightClick(Unit unit, Unit target) {
