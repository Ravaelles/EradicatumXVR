...
public class UnitType {
	...
	public String toString() {
		return "UnitType [name=" + name + ", maxHitPoints=" + maxHitPoints + ", armor=" + armor
				+ ", mineralPrice=" + mineralPrice + ", gasPrice=" + gasPrice + ", buildTime="
				+ buildTime + "]";
	}
	...
	public boolean isBarracks() {
		return getID() == UnitTypes.Terran_Barracks.ordinal();
	}

	public boolean isFactory() {
		return getID() == UnitTypes.Terran_Factory.ordinal();
	}
	...
	public boolean isLarvaOrEgg() {
		return getID() == UnitTypes.Zerg_Larva.ordinal() || getID() == UnitTypes.Zerg_Egg.ordinal();
	}
